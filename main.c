...
static void showuse( int morehelp )
{
    {
        printf( "\n" );
		printf( "  Base64 Tool by CVFD - (C) 2018\n" );
        printf( "  Usage:   b64tool -option [-l<num>] [<FileIn> [<FileOut>]]\n" );
    }
    if( morehelp == 0 ) {
        printf( "           Use -h option for additional help.\n" );
    }
    else {
        printf( "  Options: -e  encode to Base64   -h  Shows This Text\n" );
        printf( "           -d  decode from Base64 -?  Shows This Text\n" );
    }
}
